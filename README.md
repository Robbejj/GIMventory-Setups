...
Filters and reorders the Group Ironman shared bank to match the setup currently active in [Inventory Setups](https://github.com/dillydill123/inventory-setups).
